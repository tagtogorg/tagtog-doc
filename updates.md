...
<ul class="updates">
  ...
  <li class="new"><span markdown="1">Empower On-Premises system admins to [allow or disallow visitors to create accounts](on-premises-sysadmin.html#do-not-allow-visitors-to-create-accounts)</span></li>
</ul>
