...
<div class="two-third-col">
  ...
  <p>If <a href="projects.html#task-distribution">Task Distribution</a> is enabled, here you can force to which users you want to assign the importing documents to. If one or more users are selected, the automatic task distribution settings are overriden (for this import request). tagtog will distribute the document to all the users selected and only to those.</p>
